...
#ifndef _VASCON_AEAD_ASCON_DATAPATH_H_
#define _VASCON_AEAD_ASCON_DATAPATH_H_  // guard
...
class VASCON_AEAD_ASCON_ROUND_FUNCTION;


//----------

VL_MODULE(VASCON_AEAD_ASCON_DATAPATH) {
  public:
    // CELLS
    VASCON_AEAD_ASCON_ROUND_FUNCTION* asconRF1;
    
    // PORTS
    VL_IN8(__PVT__clk,0,0);
    VL_IN8(__PVT__rst,0,0);
    VL_IN8(__PVT__intial,0,0);
    VL_IN8(__PVT__inc,0,0);
    VL_IN8(__PVT__constti,3,0);
    ...
    // LOCAL SIGNALS
    CData/*3:0*/ __PVT__asconRC1__DOT__consttd;
    CData/*3:0*/ __PVT__asconRC1__DOT__consttq;
    QData/*63:0*/ __PVT__Xreg0;
    QData/*63:0*/ __PVT__Xreg1;
    QData/*63:0*/ __PVT__Xreg2;
    QData/*63:0*/ __PVT__Xreg3;
    QData/*63:0*/ __PVT__Xreg4;
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VASCON_AEAD_ASCON_DATAPATH);  ///< Copying not allowed
  public:
    VASCON_AEAD_ASCON_DATAPATH(const char* name = "TOP");
  ...
  public:
    static void _sequent__TOP__ASCON_AEAD__ascondatapath1__1(VASCON_AEAD__Syms* __restrict vlSymsp);
    static void _settle__TOP__ASCON_AEAD__ascondatapath1__2(VASCON_AEAD__Syms* __restrict vlSymsp);
